...
void c_ControllerMessages::AddControls(uint16_t ctrlTab)
{
   ...
   if (Control::noParent == MessageElementIds.ActiveChoiceListElementId)
   {
      ...
      MessageElementIds.DisplayDurationElementId = ESPUI.addControl(
          ...
          ControlColor::Turquoise,
          MessageElementIds.MessageDetailsElementId);
      ESPUI.addControl(ControlType::Min, "Min", String(5), ControlColor::None, MessageElementIds.DisplayDurationElementId);
      ESPUI.addControl(ControlType::Max, "Max", String(900), ControlColor::None, MessageElementIds.DisplayDurationElementId);
   }
   else
   {
