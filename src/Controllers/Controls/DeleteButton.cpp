...
static const PROGMEM char _Title       [] = " Delete ";

// *********************************************************************************************
cDeleteButton::cDeleteButton () :   cButtonControl (_Title)
{
    // DEBUG_START;
    // DEBUG_END;
}
...
// *********************************************************************************************
void cDeleteButton::AddControls (uint16_t TabId, ControlColor color)
{
    // DEBUG_START;
