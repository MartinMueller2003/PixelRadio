...
const PROGMEM char  CSS_LABEL_STYLE_TRANSPARENT40R []  = "background-color: unset; width: 40%; text-align: right;";
const PROGMEM char  CSS_LABEL_STYLE_TRANSPARENT40C []  = "background-color: unset; width: 40%; text-align: center;";
const PROGMEM char  CSS_LABEL_STYLE_TRANSPARENT20  []  = "background-color: unset; width: 20%; text-align: left;";
